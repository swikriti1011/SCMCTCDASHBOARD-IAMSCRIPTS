...
var SENSOR_ALTERNATE_ID = 'Atlanta_Machine';
var CAPABILITY_ALTERNATE_ID = 'Flow_Sensor_Indicator_Grp';
var DEVICE_ALTERNATE_ID = '1E647BC96688406DB63B10F9E9E0CE3D';
...
const CERTIFICATE_FILE = './1E647BC96688406DB63B10F9E9E0CE3D-device_certificate.pem';
const PASSPHRASE_FILE = './1E647BC96688406DB63B10F9E9E0CE3D_secret_key.txt';
var mqttClient;
...
//alert(diffDays)
        ...
        measures: [
            ...
            {"Flow_Sensor":Flow_Sensor().toFixed(1)}
         ...
         if(!error) {
             console.log("Data successfully sent!");
              ...
              console.log("An unecpected error occurred:", error);
							  ...
							  else if(diffDays==1&& maxval==6.5 )
				 {	 
                          console.log("Running Maintenance Activity");
								 
				 }
				 
				 else if(diffDays==2 && maxval==6.5){
...
function connectToMQTT() {
    var options = {
       ...
       reconnectPeriod: 2000,
        connectTimeout: 2000,
        cert: fs.readFileSync('./1E647BC96688406DB63B10F9E9E0CE3D-device_certificate.pem'),
        key: fs.readFileSync('./1E647BC96688406DB63B10F9E9E0CE3D-device_certificate.pem'),
        passphrase: fs.readFileSync('./1E647BC96688406DB63B10F9E9E0CE3D_secret_key.txt').toString(),  
